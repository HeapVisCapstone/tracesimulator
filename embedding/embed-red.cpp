...
// float **
void embed_graph(float ** d, int n) {
	// RedSVD::RedSVD<
	...
	cout << "Running redsvd" << endl;
    RedSVD::RedSVD<Eigen::MatrixXd> red(dist,2);
	cout << "Finshed running redsvd" << endl;

	cout << "matrix u" << endl;
    cout << red.matrixU() << endl;
	cout << "matrix v" << endl;
    cout << red.matrixV() << endl;
	cout << "matrix singular values" << endl;
    cout << red.singularValues() << endl;
/*
...
#define SIZE 8
int main() {
	// int arr[SIZE] = { 10, 25, 50, 500, 500, 1000, 2000, 10000 };
